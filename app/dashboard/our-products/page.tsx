...
import { useProductEditStore } from "@/app/store/useEditProductStore"; // Import the store
...
const OurProducts: React.FC = () => {
  ...
  const { updateProductStatus } = useProductEditStore(); // Get the update function from store
                ...
                <tr key={index} className="border-b last:border-none">
                  <td className="px-6 py-4 flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p>
                        <a
                          href={`https://tourgeeky.com/details?type=G&id=${product.id}`}
                          className="cursor-pointer text-orange-500 pl-1 text-sm"
                          target="_blank"
                        >
                          Preview
                        </a>
