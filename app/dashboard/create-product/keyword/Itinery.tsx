...
const Itinery: React.FC = () => {
  ...
  const handleLocationSelect = async (address: string, index: number) => {
    try {
      ...
      toast.error("Failed to get location details. Please enter coordinates manually.");
      setUseGoogleMaps(false);
      setGoogleMapsError(true);
    }
  };
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <Switch
                            ...
                            onCheckedChange={(checked) => toggleMainStop(index, checked)}
                          />
                        </div>
                      </div>
                                  ...
                                  {status === "OK" &&
                                    data.map(({ place_id, description }) => (
                                      <CommandItem
                                        ...
                                        value={description}
                                        onSelect={() => {
                                          handleLocationSelect(description, index);
                                          clearSuggestions();
                                        }}
                                      >
                                        {description}
